...
**Air-combat maneuver** — the immediate steering technique selected under an air-combat intent, such as intercept, press, launch setup, crank, beam, drag, extend, recommit, or abstract dogfight. A maneuver owns no polymorphic runtime object; its per-flight start time, minimum commitment, side, target, aim point, and supported effect live in flight tactical state.
